...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    <body>
        <div class='container'>
            ...
            <p><a class='textoxd' href='$reset_link'>Restablecer Contraseña</a></p>
...
";
        ...
        try {
            $mail->send();
            $_SESSION['success'] = 'Correo de restablecimiento enviado. Revisa tu bandeja de entrada.';
            header('Location: /proyectofinalmulti/views/auth/contraseña_olvidada.php');
            exit();
