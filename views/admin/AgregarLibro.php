                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control" id="autor" name="lib_autor" required>
                            ...
                            <?php
                            // Código PHP para generar las opciones de autores
                            $conn = new mysqli('localhost', 'root', '', 'proyectofinalmulti');
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo '<option value="' . htmlspecialchars($row['Autores_id']) . '">' . htmlspecialchars($row['Autor_nombre']) . '</option>';
                                }
                            } else {
